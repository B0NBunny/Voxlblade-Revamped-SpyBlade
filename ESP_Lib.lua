...
function boxBase:Update()
    ...
    if self.IsEnabled and (type(self.IsEnabled) == "string" and not (savedsettings[self.IsEnabled] or ESP[self.IsEnabled]) or type(self.IsEnabled) == "function" and not self:IsEnabled()) then
        allow = false
    end
