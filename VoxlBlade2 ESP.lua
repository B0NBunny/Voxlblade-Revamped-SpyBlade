...
-- Script updated by Brycki
Keybind = "P"
DarkMode = true

-- Original Script Loadstring For Old VoxlBlade:
-- loadstring(game:HttpGet("https://raw.githubusercontent.com/Just-Egg-Salad/roblox-scripts/main/VoxlBlade%20v001%20ESP", true))()\
